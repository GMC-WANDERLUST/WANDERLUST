...
import ReportedUsersList from "./Components/AdminUI/ReportedUsersList/ReportedUsersList";
      ...
      <div className="App">
        <Switch>
          ...
          {/* <PublicRoute
                    ...
                    component={Login}
                /> */}
          <PublicRoute restricted={true} path="/login" component={LogInSide} />
          ...
          />
          <AdminRoute
            path="/adminUi/admin/reportedUsers"
            restricted={true}
            component={ReportedUsersList}
          />
          <AdminRoute
            path="/adminUi/admin/reportedPosts"
            restricted={true}
