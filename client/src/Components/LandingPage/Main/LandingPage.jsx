                                    ...
                                    <div className="u-container-style u-layout-cell u-left-cell u-opacity u-opacity-40 u-size-30 u-layout-cell-2">
                                        <div className="u-container-layout u-container-layout-2">
                                            <p className="u-text u-text-body-alt-color u-text-2">
                                                At <b>&nbsp;WanderLust Inc.</b>{" "}
                                                ,we want to make sure every
                                                client's trip is nothing short
                                                of perfect.Technology has
                                                changed the way the traveling
                                                public shops for travel. We feel
                                                personalized service is the
                                                utmost important factor in
                                                planning travel. Something the
                                                internet cannot possibly give.
                                                We work hard to maintain our 99%
                                    ...
                                    <div className="u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                                        <div className="u-container-layout">
                                            ...
                                            <p className="u-text u-text-body-alt-color u-text-5">
                                                ...
                                                frustration of expensive
                                                accomodation out of planning
                                                your vacation.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                                        <div className="u-container-layout u-valign-middle u-container-layout-2">
                                            <p className="u-text u-text-2">
                                                ...
                                                celebrated network of travel
                                                hosts around the world. Wherever
                                                you want to go, however you want
                                                to get there, whatever you want
                                                to do ,we have the ideal travel
                                                host match just for you.{" "}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    <div className="u-clearfix u-sheet u-sheet-1">
                        <div className="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                            <div className="u-layout">
                                <div className="u-layout-row">
                                    <div className="u-align-right u-container-style u-image u-layout-cell u-left-cell u-size-30 u-image-1 wl-box-items">
                                    ...
                                    <div className="u-container-style u-layout-cell u-left-cell u-opacity u-opacity-40 u-size-30 u-layout-cell-1">
                                        <div className="u-container-layout u-container-layout-1">
                                            <p className="u-text u-text-body-alt-color u-text-1">
                                                ...
                                                integrity and honesty through
                                                hard work, organization,
                                                cleanliness, courtesy, and
                                                communication. Our entire team
                                                works hard to exceed all
                                                customer expectations. Please
                                                give us a call today for more
                                                information on the services we
                                                offer. We are more than happy to
                                                ...
                                                believe this can only be
                                                accomplished by providing
                                                superior service, quality lines,
                                    ...
                                    <div className="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                                        <div className="u-container-layout u-valign-middle-sm">
                                            ...
                                            <h2 className="u-custom-font u-font-ubuntu u-text u-text-body-alt-color u-text-2">
                                                We Have Over 24 Years of Travel
                                                Experience
                                            </h2>
                                        </div>
                                    </div>
                                                ...
                                                >
                                                    ...
                                                    <div className="u-form-group u-form-submit">
                                                        ...
                                                        {/* <input
                                                            type="button"
                                                            value="Send"
                                                            className="u-btn u-btn-submit u-button-style  u-border-white u-form-control-hidden"
                                                            onClick={handleSend}
                                                        /> */}
                                                        <form>
                                                            <input
