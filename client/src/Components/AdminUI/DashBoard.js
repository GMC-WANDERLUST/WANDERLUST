            ...
            <div className="col-12 col-sm-6 col-md-3">
              <div className="info-box">
                ...
                <div className="info-box-content">
                  ...
                  <span className="info-box-number">{numberOfPosts}</span>
                </div>
              </div>
            </div>
            <div className="col-12 col-sm-6 col-md-3">
              <div className="info-box mb-3">
                ...
                <div className="info-box-content">
                  <span className="info-box-text">Hosting Posts</span>
                  <span className="info-box-number">{numberOfHosts}</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-md-3">
              <div className="info-box mb-3">
                ...
                <div className="info-box-content">
                  ...
                  <span className="info-box-number">{numberOfUsers}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              {reportedPosts
                .map((post, index) => {
                  if (index < 4) {
                    return (
                      <div key={post._id}>
                        <CardPost token={token} post={post} id={id} />
                      </div>
                    );
                  }
                })
