            ...
            <div className="container-fluid">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <div className="info-box">
                    ...
                    <div className="info-box-content">
                      ...
                      <span className="info-box-number">1,111</span>
                    </div>
                    {/* /.info-box-content */}
                  </div>
                  {/* /.info-box */}
                      ...
                      <div className="row">
                        <div className="col-md-8">
                          <p className="text-center">
                            <strong>Visits: 1 Jul, 2021 - 31 Jul, 2021</strong>
                          </p>
                          <div className="chart">
                            {/* Sales Chart Canvas */}
                            <canvas
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                      ...
                      <div className="d-md-flex">
                        ...
                        <div className="card-pane-right bg-success pt-2 pb-2 pl-4 pr-4">
                          <div className="description-block mb-4">
                            <h5 className="description-header">23,588,390</h5>
                        ...
                        <div className="card-body">
                          ...
                          <div className="direct-chat-messages">
                            ...
                            <div className="direct-chat-msg right">
                              ...
                              {/* /.direct-chat-img */}
                              <div className="direct-chat-text">
                                Is this application really for free? That's
                                unbelievable!
                              </div>
                              {/* /.direct-chat-text */}
                            </div>
                            ...
                            <div className="direct-chat-msg right">
                              ...
                              {/* /.direct-chat-img */}
                              <div className="direct-chat-text">
                                I'm really in love with this application! Thank
                                you !
                              </div>
                              {/* /.direct-chat-text */}
                            </div>
                        ...
                        <div className="card-body p-0">
                          <ul className="users-list clearfix">
                            ...
                            <li>
                              ...
                              <span className="users-list-date">12 July</span>
                            </li>
                            <li>
                              <img
                                src="dist/img/user6-128x128.jpg"
                            ...
                            <li>
                              ...
                              <span className="users-list-date">13 July</span>
                            </li>
                            <li>
                              <img
                                src="dist/img/user5-128x128.jpg"
                              ...
                              <span className="users-list-date">14 July</span>
                            </li>
                            <li>
                              <img
                              ...
                              <span className="users-list-date">15 July</span>
                            </li>
                            <li>
                              <img
                                src="dist/img/user3-128x128.jpg"
                  ...
                  <div className="card">
                    <div className="card-header border-transparent">
                      <h3 className="card-title">Reported Users</h3>
                      <div className="card-tools">
                        <button
                          type="button"
                          className="btn btn-tool"
                ...
                <div className="col-md-4">
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h3 className="card-title">Recently Added Posts</h3>
                      <div className="card-tools">
                        <button
                          type="button"
                          className="btn btn-tool"
